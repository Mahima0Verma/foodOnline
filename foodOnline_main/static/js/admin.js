...
//Booking status updation 
const statusUpdation =document.querySelectorAll(".status-updation");

if (statusUpdation) {
    statusUpdation.forEach(function(button) {
...
const editStatus= document.getElementById("editStatusForm");
if(editStatus){
    editStatus.addEventListener("submit",function(event){
        event.preventDefault();
